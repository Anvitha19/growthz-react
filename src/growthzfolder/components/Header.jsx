...
const Header = () => {
    ...
    return (
        ...
        <div className='container '>
            ...
            <div className='md:flex  justify-between bg-white  py-4'>
                    <img src={Logo} alt="Logo" className='w-36 h-auto ml-20'></img>
                <div onClick={() => setOpen(!open)} className='text-3xl absolute right-8 top-6 cursor-pointer md:hidden'>
                    <ion-icon name={open ? 'close' : 'menu'}></ion-icon>
                </div>
                <ul className={`mr-20 md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-20 ' : 'top-[-490px]'}`}>
