    ...
    <div className='w-full py-16'>
      <div className="bg-[#6E18F3] mx-auto">
        <div className='items-center text-center justify-center mx-auto w-[70%]'>
            <h2 className='text-white md:text-[57px] sm:text-5xl font-black italic py-9 leading-none max-[876px]:text-[25px]'>Maximize Your Digital Presence with Our Expertise</h2>
            <div className='pb-8'>
        ...
        <img src={HeroFooter} alt="/" className='max-[876px]:hidden -mt-[250px] -ml-[70px] '/>
        </div>
    </div>
    </div>
  )
